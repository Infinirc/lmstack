 ...
 */
import { Collapse, Form, Input, InputNumber, Select, Switch, Tabs, Typography, Space } from 'antd'
...
const OllamaParams = () => (
  <>
    ...
    >
      <InputNumber min={1} max={1024} placeholder="512" style={{ width: '100%' }} />
    </Form.Item>
    <Form.Item
...
export default function DeploymentAdvancedForm({ backend }: DeploymentAdvancedFormProps) {
    ...
    const tabItems = [
      {
        key: 'performance',
        label: 'Performance',
        children: isVllm ? <VllmPerformanceParams /> : <SglangPerformanceParams />,
      },
      {
        key: 'scheduling',
        label: 'Scheduling',
        children: isVllm ? <VllmSchedulingParams /> : <SglangSchedulingParams />,
      },
      {
        key: 'advanced',
        label: 'Advanced',
