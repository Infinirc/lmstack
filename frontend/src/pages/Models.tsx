...
const OllamaLogo = ({ height = 16, isDark }: { height?: number; isDark: boolean }) => (
  <img
...
export default function Models() {
  ...
  const [currentSource, setCurrentSource] = useState<'huggingface' | 'ollama'>('huggingface')
      ...
      >
        <Form form={form} layout="vertical" onFinish={handleCreate}>
          ...
          >
            ...
            >
              <Input
                placeholder={currentSource === 'ollama' ? 'e.g., qwen2.5:7b' : 'e.g., Qwen/Qwen2.5-7B-Instruct'}
        ...
        <Form form={editForm} layout="vertical" onFinish={handleUpdate}>
          {editingModel && (
            <div style={{ marginBottom: 16, padding: 12, background: isDark ? '#1f1f1f' : '#f5f5f5', borderRadius: 8 }}>
              <div style={{ fontSize: 12, color: '#888', marginBottom: 4 }}>Model ID</div>
